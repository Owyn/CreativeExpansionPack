...
namespace FraggleExpansion
{
    public class SlimeGamemodesManager
    {
        ...
        public void PublishState()
        {
            ...
            LevelEditorManagerUI.ShowGenericPopup("wle_creativeexpansion_stop", "wle_creativeexpansion_stop_description", "wle_creative_expansion_stop_confirm", LevelEditorManager.Instance.UI._errorSprite, UIModalMessage.OKButtonType.Disruptive, ActionOnClick, UIModalMessage.ModalType.MT_OK, PopupInteractionType.Warning);
